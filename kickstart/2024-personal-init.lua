...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Custom ***
      vim.keymap.set('n', '<leader>sc', ':nohlsearch<CR>', { desc = '[S]earch [C]lear Selection' })
      -- ***
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'cpp', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'typescript', 'javascript', 'html', 'go' },
...

  {
    ...
    config = function()
      ...
      null_ls.setup {
        ...
        conditions = {
          {
            condition = opts.prettier_formatting.condition,
            sources = {
